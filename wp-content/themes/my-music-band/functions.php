 ...
 */
 ...
 /**
 * Disable themes update notification in Administration to not ruin fucking everything !
 */
function disable_parent_theme_update_notification( $value ) {
    if ( isset( $value ) && is_object( $value ) ) {
        unset( $value->response['my-music-band'] );
    }
    return $value;
}
add_filter( 'site_transient_update_themes', 'disable_parent_theme_update_notification' );
function disable_child_theme_update_notification( $value ) {
    if ( isset( $value ) && is_object( $value ) ) {
        unset( $value->response['rock-band'] );
    }
    return $value;
}
add_filter( 'site_transient_update_themes', 'disable_child_theme_update_notification' );
